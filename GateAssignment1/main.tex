...
%
\begin{lstlisting}
https://github.com/KBVijayVarma/EE3900/tree/main/GateAssignment1
\end{lstlisting}
...
Hence, the overall impulse response of the cascaded system is given by convolution of $h_1$(t) and $h_2$(t).
